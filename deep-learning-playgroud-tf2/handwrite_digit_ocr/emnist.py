...
img_file = r'E:\_dataset\digit_and_character\emnist_dataset\emnist-balanced-train-images-idx3-ubyte'  # Path to your xxx-images-idx3-ubyte
label_file = r'E:\_dataset\digit_and_character\emnist_dataset\emnist-balanced-train-labels-idx1-ubyte'  # Path to your xxx-labels-idx1-ubyte
generate_img_root = r"E:\_dataset\digit_and_character\emnist_dataset"  # Path to save the images
...
for i in range(len(train_label_lis)):
    ...
    make_dir(subdir)
    image_name = label_name + "_" + str(i) + '.jpg'
