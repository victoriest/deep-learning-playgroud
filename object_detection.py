...
with tf.Graph().as_default():
    ...
    with tf.gfile.Open("1.jpg", "rb") as binfile:
...
cv2.imshow("est", image_with_boxes)
cv2.waitKey(0)

# img = cv2.imread("21077.jpg")
#
# image_tensor =img.reshape(-1, 410, 410, 3) / 255.0
#
...
#     print(sess.run(class_names, dict={}))
#
# print(tf.Session.run(class_names, fetches=img.reshape(-1, 410, 410, 3) / 255.0))
#
